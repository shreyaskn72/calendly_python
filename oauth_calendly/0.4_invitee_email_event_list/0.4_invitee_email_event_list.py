...
def list_events(access_token, invitee_email, organization):
    ...
    params = {
        ...
        'organization': organization  # Replace with your organization ID
    }
    ...
    if response.status_code == 200:
        ...
        for event in events_data:
            ...
            print("Start Time:", event_start_time)
            print("End Time:", event_end_time)
            print()
...
@app.route("/get_events_by_invitee_email", methods=["POST"])
def get_events_by_invitee_email():
    access_token = request.json['access_token']
    ...
    all_events = list_events(access_token=access_token, invitee_email=invitee_email, organization=current_organization)
    return all_events
